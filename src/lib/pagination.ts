...
export class Pagination {
	...
	calculatePaginatedResults(searchResults: Results) {
		...
		paginatedResults.firstResult = searchResults.page * searchResults.size + 1
		paginatedResults.lastResult =
			searchResults.page * searchResults.size + searchResults.results.length
		paginatedResults.totalResults = searchResults.totalResults
		paginatedResults.pageCount = searchResults.totalResults / searchResults.size
