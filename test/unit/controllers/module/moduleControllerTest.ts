...
describe('Module Controller Tests', function() {
	...
	it('should delete module', async function() {
		...
		learningCatalogue.deleteModule = sinon.stub().returns(Promise.resolve(course))
	...
	it('should pass to next if deleting module throws error', async function() {
		const deleteModule: (request: Request, response: Response, next: NextFunction) => void = moduleController.deleteModule()
		...
		learningCatalogue.deleteModule = sinon.stub().returns(Promise.reject(error))
