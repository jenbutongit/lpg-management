...
describe('Face-to-face module controller tests', function() {
	...
	it('Should try to set module and pass to next if errors occurred', async function() {
	...
	it('Should check for errors, update module and pass to next if error occured', async function() {
		...
		moduleValidator.check = sinon.stub().returns({})
		learningCatalogue.updateModule = sinon.stub().returns(Promise.reject(error))
